<div class="small-12 medium-6 large-3 columns animated fadeIn article-montre">
    ...
    <span>
        ...
        <span class="price-black"><?php echo $price = get_post_meta( get_the_ID(), '_regular_price', true); ?>€</span>
        ...
        <form class="cart add-to-cart-accueil" method="post" enctype="multipart/form-data">
        	...
        	<button type="submit" class="single_add_to_cart_button button alt ajouter nouveaux-arrivants">Ajouter au panier</button>
        </form>
    </span>
</div>
